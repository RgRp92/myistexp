...
class Constants(BaseConstants):
    ...
    a11 = [4550, 4500, 4450 , 4400 , 4350, 4330, 4300, 4200, 4280, 4230]
    a12 = [5000, 5100, 5150, 5200, 5250, 5300, 5350, 5400, 5420, 5450]
    b11 = 3500
    b12 = 6000
    a1 = a11[0]
    a2 = a11[1]
...
class Player(BasePlayer):
    ...
    def set_payoff_HL(self):
        ...
        # if the random number is slarger than the random row
            if self.participant.vars['HL_choice'] == 1 :#A
                # if the choice was A
                self.participant.vars['payoff_HL'] = Constants.a12[self.participant.vars['HL_row']-1]
                # because HL_row is the same as p in the MPL
            else:
